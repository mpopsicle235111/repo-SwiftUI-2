...
class FriendPhotoCollectionViewController: UIViewController {
    ...
    //2 navigation buttons to send selected photos to Device Gallery
    ...
    private var numberOfSelectedPhotos: Int {
        return photoCollectionView?.indexPathsForSelectedItems?.count ?? 0  //If there are none - it's zero
    }
    ...
    func refresh() {
        ...
        self.photoCollectionView?.selectItem(at: nil, animated: true, scrollPosition: [])
